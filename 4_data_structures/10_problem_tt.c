...
void print_postorder(int *preorder, int *inorder, const int begin_inorder, const int end_inorder) {
    int count = 0;
    printf("%d ", preorder[0]);
    ...
    print_postorder(preorder, inorder, begin_inorder, count - 1);
}
...
int main() {
    ...
    print_postorder(preorder, inorder, 0, sz - 1);
